class PeepsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @peep.save
        format.html { redirect_to peep_url(@peep), notice: "Peep was successfully created." }
  ...
  def update
    respond_to do |format|
      if @peep.update(peep_params)
        format.html { redirect_to peep_url(@peep), notice: "Peep was successfully updated." }
  ...
  private
    ...
    def peep_params
      params.require(:peep).permit(:firstname, :lastname, :email, :slug)
    end
end
